                            ...
                            <thead>
                                <tr>
                                    ...
                                    <?php foreach($columns as $column){?>
                                        <th  data-order-by="<?php echo $column->field_name; ?>"><?php echo $column->display_as; ?></th>
                                    <?php }?>
                                </tr>

                                <tr class="filter-row gc-search-row info">
                                          ...
                                          <div class="clear"></div>
                                            ...
                                            <div class="floatR r5">
                                                <ul class="pagination">
                                                    ...
                                                    <li>
                        <span class="page-number" style="width:80px;
height:34.3px;">
