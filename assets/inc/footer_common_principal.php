...
<br>
<div align="left">
		<a href="" title=""><img width="50" height="50" src="<?php echo $this->config->base_url();?>assets/img/visa_electron.png" alt=""/></a>
</div>
 <!--//end-bottom-->
		<!--start-footer-->
		<div align="left">
	     <div class="footer" style="background-color: #333;">
				...
				<a  class="sin_raya" style="color: #FFFFFF;" href="#"><h6>Esta tienda esta autorizada por Visa para realizar transacciones electronicas &nbsp &nbsp &nbsp &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</a>
			...
			<a class="sin_raya" style="color: #FFFFFF;" href="<?=$this->config->base_url()?>pagina_principal/contactanos">Contactanos &nbsp;</a>	
				<a class="sin_raya" style="color: #FFFFFF;" href="<?=$this->config->base_url()?>pagina_principal/pol_ter_con">&nbsp;&nbsp;Politicas,Terminos y Condiciones</h6> &nbsp;</a>
