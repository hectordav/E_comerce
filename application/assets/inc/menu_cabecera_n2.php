...
<div class="top_bg" id="home">
  <div class="container">
    <div class="header_top">
      <div class="top_right">
       <ul>
           <li style="border-right: 0px solid #fff; */"><a class="sin_raya"href="<?=$this->config->base_url()?>pagina_principal/home"><h4>Encurvas</h4></a></li>
       </ul>
      </div>
      <div class="top_left">
  ...
  <div class="header">
    ...
    <div class="col-md-3 col-sm-3 col-xs-12 col-md-offset-9">
     ...
     <div class="logo">
        ...
        <a class="sin_raya" href="<?=$this->config->base_url()?>pagina_principal/home"><h1>E- <span>Comerce</span></h1> </a>
      </div>
