...
<section id="intro" class="intro-section">
  ...
  <?= validation_errors('<div class="alert alert-danger">','</div> ')?>
             ...
             <label><h3><strong>Agregar Producto a la Seccion Modas</strong></h3></label>
             <hr>
        <form  role="form" action="<?php echo $this->config->base_url();?>modas/guardar_modas" method="POST"  enctype="multipart/form-data">
