...
<section id="intro" class="intro-section">
  ...
  <?= validation_errors('<div class="alert alert-danger">','</div> ')?>
             ...
             <label><h3><strong>Editar Sub Categoria</strong></h3></label>
             <hr>
        <form  role="form" action="<?php echo $this->config->base_url();?>sub_categoria/actualizar_subcategoria" method="POST"  enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <?php if ($sub_categoria): ?>
              <?php foreach ($sub_categoria as $key): ?>
                <input type="hidden" name="txt_id_sub_categoria" value="<?=$key->id?>">
              <input type="text" class="form-control" name="txt_sub_categoria" value="<?=$key->descripcion?>" placeholder="Ingrese Sub Categoria">
              <?php endforeach ?>
              <?php endif ?>
            </div>
            <hr>
