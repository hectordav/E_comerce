...
<br>
  ...
  <li role="presentation"><a href="<?=$this->config->base_url()?>producto/grilla">Productos</a></li>
  <li role="presentation" class="active"><a href="<?= $this->config->base_url()?>inventario_producto/grilla">Inventario</a></li>
