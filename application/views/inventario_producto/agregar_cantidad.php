...
<section id="intro" class="intro-section">
  ...
  <?= validation_errors('<div class="alert alert-danger">','</div> ')?>
          ...
          <div class="animated fadeIn" align="left">
             <label><h3><strong>Agregar Cantidad a Inventario</strong></h3></label>
             <hr>
        <form  role="form" action="<?php echo $this->config->base_url();?>inventario_producto/actualizar_cantidad" method="POST"  enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label>Cantidad a Agregar</label>
               <input type="number" name="txt_cantidad_1" id="txt_cantidad_1" onkeyup="fncSumarCantidad()" class="form-control" value="" placeholder="Ingrese Cantidad">
