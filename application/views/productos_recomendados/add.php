...
<section id="intro" class="intro-section">
  ...
  <?= validation_errors('<div class="alert alert-danger">','</div> ')?>
             ...
             <label><h3><strong>Agregar Producto en la Seccion Productos Recomendados</strong></h3></label>
             <hr>
        <form  role="form" action="<?php echo $this->config->base_url();?>productos_recomendados/guardar_productos_recomendados" method="POST"  enctype="multipart/form-data">
            ...
            <div class="form-group" align="center">
              ...
              <a href="<?=$this->config->base_url()?>productos_recomendados" title="" class="btn btn-warning btn-lg"><i class="fa fa-exclamation-triangle"></i>&nbsp;Volver</a>
            </div>
          </form>  
