...
<section id="intro" class="intro-section">
  ...
  <?= validation_errors('<div class="alert alert-danger">','</div> ')?>
             ...
             <label><h3><strong>Editar Producto</strong></h3></label>
             <hr>
        <form  role="form" action="<?php echo $this->config->base_url();?>producto/actualizar_producto" method="POST"  enctype="multipart/form-data">
      ...
      <input type="checkbox"id="tipo_check" name="color[]" value="<?= $i->id;?>">&nbsp;&nbsp;&nbsp;<?= $i->descripcion?> &nbsp;&nbsp;&nbsp;
            ...
            <input type="hidden" name="txt_id_producto" value="<?=$key->id_producto?>">
              ...
              <label>Codigo</label>
             <input type="text" name="txt_codigo" class="form-control" value="<?= $key->codigo?>" placeholder="Ingrese Codigo de Producto">
            </div>
            <div class="form-group">
              <label>Nombre</label>
             <input type="text" name="txt_nombre" class="form-control" value="<?= $key->nombre?>" placeholder="Ingrese Nombre de Producto">
            </div>
            <div class="form-group">
              <label>Descripcion</label>
             <textarea class="form-control" placeholder="Ingrese Descripcion del producto" name="txt_descripcion"><?= $key->descripcion?></textarea>
            </div>
